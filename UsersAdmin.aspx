<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UsersAdmin.aspx.cs" Inherits="CyberglobesAdminSite.UsersAdmin" %>
<!DOCTYPE html>
        ...
        <AjaxSettings>
          ...
          <div class="container-fluid" style="height:90%">
                    ...
                    <telerik:RadGrid   AllowAutomaticUpdates="True" AutoGenerateEditColumn="True" ID="RadGrid1" runat="server"  AllowSorting="True"  DataSourceID="SqlDataSource1" Skin="BlackMetroTouch"
						...
						<MasterTableView AutoGenerateColumns="False" DataSourceID="SqlDataSource1" DataKeyNames="Id"  CommandItemDisplay="Top">
							<Columns>
					...
					<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:CyberglobesAppConnectionString %>" 
						InsertCommand="INSERT INTO [CyberglobesClientUsers] ([Username], [Password], [Email], [Organization], [SoftwareActive], [WebActive], QueriesRemaining,QueriesGiven,StartDate,[EndDate],[PermissionsLevel]) VALUES (@Username, @Password, @Email, 'BrazilFedPolice', 1, 1,50000, 5000,GETDATE(),'20240101','FBLevel1,INSTALevel1,ProfilerLevel1,TwitterLevel1,YouTubeLevel1,VKLevel1,WeiboLevel1')"
						UpdateCommand="Update [CyberglobesClientUsers] SET [Username] = @Username, [Password] = @Password, [Email] = @Email WHERE [Id] = @Id" 
						SelectCommand="SELECT [Id], [Username], [Password], [Email], [StartDate], [EndDate] FROM [CyberglobesClientUsers]">
						<UpdateParameters>
